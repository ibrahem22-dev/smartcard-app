...
export const enBySource: Readonly<Record<string, string>> = {
  ...
  'תשלומים לפירעון': 'Installments due',
  'שום דבר לא מתוזמן ליום הזה': 'Nothing is scheduled for this day',
  'שום דבר מהסוג הזה לא מתוזמן ליום הזה': 'Nothing in this category is scheduled for this day',
  'הסכומים מפורטים למטה; המנוע לא פרסם סך יומי': 'Amounts are listed below; the engine published no daily total',
  'יוצאים {{outflow}} ונכנסת משכורת {{salary}}': 'Outflow is {{outflow}} and salary in is {{salary}}',
  'יוצאים {{outflow}}; משכורת לא נכנסת היום': 'Outflow is {{outflow}}; salary does not land today',
  'לא יוצא סכום מתוזמן; נכנסת משכורת {{salary}}': 'No scheduled amount leaves; salary in is {{salary}}',
  'אין יציאה מתוזמנת ואין כניסת משכורת היום': 'No scheduled outflow and no salary lands today',
  'יש לבחור יום כדי לראות מה מתוזמן': 'Choose a day to see what is scheduled',
  'עדיין לא נבחר יום': 'No day has been selected yet',
  ...
  'סך ההתחייבויות החודשיות': 'Total monthly commitments',
  'עומס מול הכנסה': 'Load against income',
  'תקרת התחייבויות חודשית': 'Monthly commitment cap',
  'הצעה לפי סף האזהרה החזקה': 'Suggested from the strong-warning threshold',
  'הכנס תקרה בשקלים': 'Enter a cap in shekels',
  'לא נטען פרופיל מהכספת, ולכן אין הכנסה שאפשר למדוד מולה': 'No vault profile is loaded, so there is no income to measure against',
  'לא הוזנה הכנסה חודשית; ליחס העומס אין מכנה': 'No monthly income has been captured; a load ratio has no denominator',
  'תוצאת העומס אינה זמינה': 'The load result is unavailable',
  'אין כרטיסים בכספת': 'There are no cards in the vault',
  'אין מועדי חיוב זמינים': 'No billing dates are available',
  ...
  'מסגרת פנויה לפני שינויים': 'Available before changes',
  'מסגרת פנויה אחרי שינויים': 'Available after changes',
  'מסגרת ששוחררה בתשלום מוקדם': 'Released by early payoff',
  'סף אזהרה': 'Warning threshold',
  'סף אזהרה חזקה': 'Strong-warning threshold',
  ...
  לומדים: 'Learn',
  'לומדים: מילון, זכויות ואנשי קשר': 'Learn: glossary, rights and contacts',
  'מילון, זכויות ודרכי קשר מתוך חבילת התוכן של האפליקציה.':
    "Glossary, rights and contact channels from the app's content pack.",
  מילון: 'Glossary',
  זכויות: 'Rights',
  'אנשי קשר': 'Contacts',
  '{{label}} ({{count}})': '{{label}} ({{count}})',
  'מעמד המונח בערבית: {{status}}': 'Arabic term status: {{status}}',
  'מצב אימות: {{status}}': 'Verification: {{status}}',
  'הערה: {{note}}': 'Note: {{note}}',
  'מועדים: {{value}}': 'Deadlines: {{value}}',
  'למי פונים: {{value}}': 'Who to contact: {{value}}',
  'אין ערך שפורסם': 'No value was published',
  'אומת מול מקור רשמי': 'Verified against an official source',
  'אומת מול כמה מקורות': 'Corroborated by multiple sources',
  'מבוסס על מקור יחיד': 'Based on a single source',
  'המקורות סותרים': 'Sources conflict',
  'נגזר מנתונים קיימים': 'Derived from existing data',
  'נגזר ממקור רשמי': 'Derived from an official source',
  'לא פורסם': 'Not published',
  'דורש כניסה לחשבון': 'Requires account access',
  'תלוי בלקוח': 'Customer-specific',
  'מידע היסטורי': 'Historical information',
  'לא נמצא לאחר בדיקה': 'Unknown after research',
  'סטטוס לא ידוע': 'Unknown status',
  'לא רלוונטי': 'Not applicable',
  'סטטוס אימות שהאפליקציה לא מזהה': 'Verification status not recognised by this app',
  'מונח ערבי רשמי': 'Official Arabic term',
  'שימוש ערבי מקובל': 'Common Arabic usage',
  'תעתיק לערבית': 'Arabic transliteration',
  'ניסוח ערבי שלנו; לא נמצא מונח רשמי': 'Our Arabic rendering; no official term was found',
  'ארגון פעיל': 'Current organisation',
  'ארגון היסטורי שמוזג': 'Historical merged organisation',
  'שם משפטי בעברית': 'Legal name in Hebrew',
  'שם משפטי בערבית': 'Legal name in Arabic',
  'שם משפטי באנגלית': 'Legal name in English',
  'טלפון שירות לקוחות': 'Customer-service phone',
  'שעות שירות לקוחות': 'Customer-service hours',
  'אובדן או גניבת כרטיס': 'Lost or stolen card',
  'דוא״ל לתלונות': 'Complaints email',
  'נציב תלונות הציבור': 'Complaints commissioner',
  'ערוץ להכחשת עסקה': 'Transaction-dispute channel',
